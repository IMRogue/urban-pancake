...
// configuration step. It creates a namespace called `urban_pancake`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", urban_pancake::cmake::project_name, urban_pancake::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", urban_pancake::cmake::project_version);
      return EXIT_SUCCESS;
    }
